...
class SearchProfessorHandler(Handler):
    ...
    def handle(self, context):
        try:
            ...
            procurar = driver.find_element(By.XPATH, "/html/body/div/div/main/div[2]/main/div/section[1]/div[3]/form/div[1]/input")
            procurar.clear()
            procurar.send_keys(professor)
            time.sleep(2)
            clicar = driver.find_element(By.XPATH, "/html/body/div/div/main/div[2]/main/div/section[1]/div[3]/form/div[1]/button")
            clicar.click()
            time.sleep(5)
...
class SaveResumeHandler(Handler):
    def handle(self, context):
        try:
            ...
            context['subject'].notificar(professor, "concluído")
        except Exception as e:
